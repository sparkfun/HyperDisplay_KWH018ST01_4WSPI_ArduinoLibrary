...
void setup() {
  ...
  */
  ...
  ILI9163C_color_18_t colorArray[CCLength];         // Declare an array of color structures
  ...
  myTFT.line(2,2, 126,2, 4, (color_t)colorArray, CCLength, 0);
  ...
  ILI9163C_color_18_t rectColorArray[rectCCLength];         // Declare an array of color structures
  ...
  */
  ...
  for(uint8_t indi = 0; indi < 3; indi++){
    ...
    myTFT.line(1,1, 126,78);                      // Use the window's default color to draw a line on the window - notice that it is truncated beyond the window area
  }
  delay(5000);
